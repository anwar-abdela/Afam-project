...
function SummaryCard({ title, value, color, icon, detail }) {
    const colors = {
        ...
        violet: 'from-violet-500 to-violet-600 shadow-violet-100 text-violet-600',
        ...
        <div className="space-y-12 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-black text-gray-900 tracking-tighter leading-none">
                        Welcome back, <span className="text-indigo-600 italic uppercase">System Admin</span>
                    </h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link to="/sales" className="bg-indigo-600 px-6 py-3 rounded-2xl text-white text-sm font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all active:scale-95 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 pb-12">
                <div className="xl:col-span-2 bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-sm relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-50/50 blur-[80px] rounded-full -translate-y-1/2 translate-x-1/2"></div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between mb-8 relative z-10 gap-4">
                        ...
                        <div className="bg-indigo-600/5 px-4 py-2 rounded-xl text-indigo-600 font-black text-lg tracking-tighter tabular-nums border border-indigo-100">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 relative z-10">
                        ...
                        <div className="p-6 rounded-3xl bg-gray-50/50 border border-gray-100 text-center group-hover:bg-indigo-600 transition-all duration-500">
                ...
                <div className="bg-gradient-to-br from-[#1E293B] to-[#0F172A] rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-indigo-200">
                    ...
                    <div className="absolute -top-10 -right-10 w-40 h-40 bg-indigo-500 opacity-20 blur-[60px] rounded-full"></div>

                    <div className="flex items-center justify-between mb-8 relative z-10">
                        <h3 className="text-xl font-black tracking-tight italic uppercase">System Intel</h3>
                        <div className="px-2 py-0.5 bg-indigo-500/20 rounded-md text-[10px] font-bold text-indigo-400 border border-indigo-500/30 uppercase tracking-widest">Encrypted</div>
                    </div>
                    ...
                    <div className="mt-20 relative z-10">
                        <Link to="/products" className="group w-full flex items-center justify-between bg-white text-slate-900 font-black px-6 py-4 rounded-2xl hover:bg-indigo-50 transition-all active:scale-95 shadow-xl shadow-black/40">
